...
namespace Infrastructure
{
    public class MongoGenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public IQueryable<T> Table => _context.Set<T>().AsNoTracking().ToList().AsQueryable(); //Load items into memory and return as queryable for MongoDB as it does not support IQueryable
